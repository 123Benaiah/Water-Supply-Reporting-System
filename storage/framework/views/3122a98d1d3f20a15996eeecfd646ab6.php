...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'AquaReport - Water Supply System'); ?></title>
    ...
    <?php else: ?>
                ...
                <div class="flex justify-between h-16">
                    <div class="flex items-center">
                        ...
                        <div class="hidden md:flex items-center ml-10 space-x-1">
                            <a href="<?php echo e(route('dashboard')); ?>" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-ocean-50 hover:text-ocean-600 transition font-medium <?php echo e(request()->routeIs('dashboard') ? 'bg-ocean-50 text-ocean-600' : ''); ?>">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/>
                                </svg>
                                Dashboard
                            </a>
                            <a href="<?php echo e(route('reports.create')); ?>" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-ocean-50 hover:text-ocean-600 transition font-medium">
                                <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <?php if(Auth::user()->isAdmin()): ?>
                                <a href="<?php echo e(route('admin.dashboard')); ?>" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-aqua-50 hover:text-aqua-600 transition font-medium <?php echo e(request()->routeIs('admin.*') ? 'bg-aqua-50 text-aqua-600' : ''); ?>">
                                    <svg class="w-4 h-4 inline mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div class="flex items-center space-x-4">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="hidden md:block">
                                ...
                                <p class="text-xs text-gray-500"><?php echo e(Auth::user()->isAdmin() ? 'Administrator' : 'Reporter'); ?></p>
                            </div>
                        </div>
        ...
        <footer class="mt-12 bg-gradient-to-r from-ocean-800 to-aqua-900 text-white py-8">
            <div class="max-w-7xl mx-auto px-4 text-center">
                ...
                <p class="text-ocean-200 text-sm">&copy; <?php echo e(date('Y')); ?> Water Supply Reporting System. Protecting our most precious resource.</p>
            </div>
        </footer>
    <?php endif; ?>
</body>
</html>
<?php /**PATH C:\Users\Benaiah L\OneDrive\Documents\Water Supply Reporting System\resources\views/layouts/app.blade.php ENDPATH**/ ?>