@extends('layouts.app')
@section('title', 'Register - AquaReport')
...
<div class="min-h-screen flex">
    <div class="hidden lg:flex lg:w-1/2 water-gradient relative overflow-hidden">
        ...
        <div class="relative z-10 flex flex-col justify-center items-center w-full px-12 text-white">
            ...
            <h1 class="text-5xl font-bold mb-4 text-center">Join AquaReport</h1>
            <p class="text-xl text-ocean-100 text-center max-w-md mb-8">Be part of the community working to improve water supply and report issues in your area</p>
            <div class="grid grid-cols-2 gap-6 text-sm">
                <div class="flex items-start space-x-3">
                    ...
                    <div>
                        <p class="font-semibold">Report Issues</p>
                        <p class="text-ocean-200 text-xs">Document water problems</p>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-ocean-200 text-xs">Monitor resolution status</p>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        <p class="font-semibold">Community Impact</p>
                        <p class="text-ocean-200 text-xs">Help your neighborhood</p>
                    </div>
                </div>
                <div class="flex items-start space-x-3">
                    <div class="w-10 h-10 rounded-xl bg-white/20 flex items-center justify-center flex-shrink-0">
                    ...
                    <div>
                        ...
                        <p class="text-ocean-200 text-xs">Quick issue resolution</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 bg-gradient-to-br from-ocean-50 via-white to-aqua-50">
        <div class="w-full max-w-md">
            <div class="lg:hidden flex items-center justify-center space-x-3 mb-6">
                <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-ocean-500 to-aqua-600 flex items-center justify-center">
                    <svg class="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.26 1.26.367 3.414-1.415 3.414H4.828c-1.782 0-2.674-2.154-1.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/>
                    </svg>
                </div>
                <h1 class="text-2xl font-bold water-text-gradient">AquaReport</h1>
            </div>

            <div class="text-center mb-8">
                <h2 class="text-3xl font-bold text-gray-900">Create Account</h2>
                <p class="mt-2 text-gray-600">Join us in improving water supply management</p>
            </div>
            ...
            <div class="glass-card rounded-2xl shadow-xl p-8 card-hover">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" required 
                                class="input-water block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none @error('name') border-red-300 bg-red-50 @enderror"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" required 
                                class="input-water block w-full pl-10 pr-3 py-3 border border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none"
                ...
                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-600">
                        ...
                        <a href="{{ route('login') }}" class="font-semibold text-ocean-600 hover:text-ocean-500 transition">
                            Sign in here
